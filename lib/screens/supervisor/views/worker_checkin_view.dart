// lib/screens/supervisor/views/worker_checkin_view.dart

import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:smartcare_app/screens/supervisor/controllers/worker_checkin_controller.dart';

class WorkerCheckInView extends StatelessWidget {
  final String workerName;
  final String workerId;
  final String workerDbId;

  const WorkerCheckInView({
    super.key,
  ...
  Widget build(BuildContext context) {
    final c = Get.put(WorkerCheckInController());
                    ...
                    if (isSuccess) ...[
                      ...
                      Container(
                        ...
                        child: Row(children: [
                          ...
                          Expanded(
                            child: Text(
                              '$workerName checked in successfully!',
                              style: const TextStyle(
                                  color: _green,
                                  fontWeight: FontWeight.w600,
                                  fontSize: 14),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 20),
                          const Text('Submitting Check-In...',
                              style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.w700,
                                  color: Color(0xFF1A1A2E))),
