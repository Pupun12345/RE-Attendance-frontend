// lib/screens/admin/views/admin_manage_management_staff_view.dart
...
class AdminManageManagementStaffView extends StatelessWidget {
  const AdminManageManagementStaffView({super.key});
  ...
  Widget build(BuildContext context) {
    final c = Get.put(AdminManageManagementStaffController());
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Manage Management Staff',
