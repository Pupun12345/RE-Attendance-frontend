...
//
// class AddManagementStaffScreen extends StatefulWidget {
//   const AddManagementStaffScreen({super.key});
//
//   @override
//   State<AddManagementStaffScreen> createState() =>
//       _AddManagementStaffScreenState();
// }
//
// class _AddManagementStaffScreenState extends State<AddManagementStaffScreen> {
...
//   }
//
//   void _saveManagementStaff() async {
...
//             const SnackBar(
//               content: Text("Management Staff added successfully!"),
...
//         }
//       } else {
//         _showError(data['message'] ?? 'Failed to add staff.');
//       }
//     } catch (e) {
...
//                   onPressed: _isSaving ? null : _saveManagementStaff,
